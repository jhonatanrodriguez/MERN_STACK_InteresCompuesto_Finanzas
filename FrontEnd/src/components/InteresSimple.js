 ...
 function InteresSimple() {
    ...
    useEffect(() => {
        const dataFetch = async () => {
            try {
                const response = await fetch("http://localhost:3000/intsim");
            ...
            <NavBar/>
             ...
             <div class="flex flex-row justify-center bg-blue-50">
                 <div class="flex flex-col justify-center items-center w-3/4 pl-10">
                              <h1 class="mb-5 font-semibold text-[#3A5862] ">CLIENTE VS MONTO</h1>
                 ...
                 <div class="flex flex-col justify-center items-center w-1/2">
                     <PieChart width={400} height={400}>
                         <Pie data={data} cx={200} cy={200} labelLine={false} label={renderCustomizedLabel} name="monto"
                             outerRadius={120} fill="#8884d8" dataKey="monto" isAnimationActive={false}>
